...
.cs-hero {
    ...
    border-radius: var(--cs-radius); padding: 28px 32px; margin-bottom: 24px;
...
.form-control, .form-select { border:1.5px solid var(--cs-border); border-radius:8px; font-size:13px; padding:9px 14px; }
.form-control:focus, .form-select:focus { border-color:var(--cs-accent); box-shadow:0 0 0 3px rgba(13,148,136,.1); }
...
#cs-toast-stack { position:fixed; bottom:24px; right:24px; z-index:10000; display:flex; flex-direction:column-reverse; gap:10px; pointer-events:none; }
.cs-toast {
