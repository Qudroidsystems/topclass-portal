...
.sc-hero {
    ...
    border-radius: var(--sc-radius); padding: 28px 32px; margin-bottom: 24px;
...
$(document).ready(function () {
    ...
    var table = $('#schoolClassesTable').DataTable({
        ...
        ajax: { url: '{{ route("schoolclass.data") }}', type: 'GET',
            error: function(xhr) { console.error(xhr); toast('error', 'Load Error', 'Failed to load classes.'); }
        },
        columns: [
            ...
            preConfirm: function() {
                return new Promise(function(resolve, reject) {
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            PageLoader.hide();
                            if (res.success) resolve(res); else reject(res.message);
                        },
                        error: function(xhr) {
                            PageLoader.hide();
