...
@page {
    size: {{ $pdf_paper_size ?? 'A3' }} {{ ($pdf_orientation ?? 'landscape') }};
    margin: 10mm 8mm;
}
...
.school-header-top { background: #0f2342; padding: 8px 14px; }
.school-header-top table { width: 100%; border-collapse: collapse; }
.school-logo-cell { width: 70px; vertical-align: middle; text-align: center; }
.school-logo-cell img {
    width: 58px; height: 58px; border-radius: 50%;
    border: 2px solid rgba(255,255,255,.3); object-fit: contain; background: #fff;
}
.school-name-cell { vertical-align: middle; text-align: center; color: #fff; padding: 0 10px; }
.school-name-cell .s-name {
    font-size: 16px; font-weight: 700; text-transform: uppercase;
    letter-spacing: 1px; line-height: 1.2;
}
.school-name-cell .s-address { font-size: 8px; opacity: .8; margin-top: 3px; }
.school-name-cell .s-motto { font-size: 7.5px; font-style: italic; opacity: .75; margin-top: 2px; }
.school-header-bottom {
    background: #1e3a5f; color: #fff; text-align: center; padding: 5px;
...
.meta-strip {
    ...
    background: #f8fafc; margin-bottom: 5px; border-collapse: collapse;
}
.meta-strip .meta-cell {
    padding: 5px 10px; border-right: 1px solid #cbd5e1;
...
.grade-key {
    width: 100%; margin-bottom: 5px; border: 1px solid #e2e8f0;
    border-radius: 3px; padding: 4px 8px; background: #fafafa;
}
.grade-key-inner { font-size: 7px; color: #374151; line-height: 1.8; }
.gk-badge {
    display: inline-block; padding: 1px 6px; border-radius: 10px;
    font-weight: 700; font-size: 6.5px; margin: 0 2px; color: #fff;
}
.gk-legend {
    display: inline-block; padding: 1px 5px; border-radius: 3px;
    font-size: 6.5px; font-weight: 700; margin: 0 2px;
}

.broadsheet-wrap { width: 100%; overflow: hidden; margin-bottom: 6px; }
table.bst {
    width: 100%; border-collapse: collapse;
    border: 1.5px solid #0f2342; font-size: 7px;
}
table.bst thead tr.row-subjects th {
    background: #0f2342; color: #fff; text-align: center;
    padding: 5px 3px; border: 0.5px solid rgba(255,255,255,.15);
    font-weight: 700; font-size: 7.5px; white-space: nowrap;
}
table.bst thead tr.row-subjects th.th-fixed {
    background: #0a1930; text-align: left; padding-left: 5px; white-space: nowrap;
}
table.bst thead tr.row-subjects th.th-subj {
    background: #163562; border-left: 1.5px solid #2563eb;
    font-size: 7px; white-space: normal; word-break: break-word; min-width: 40px;
}
table.bst thead tr.row-subs th {
    background: #1a3d6a; color: #a8d4ef; text-align: center;
    padding: 3px 2px; border: 0.5px solid rgba(255,255,255,.1);
    font-size: 6px; white-space: nowrap;
}
table.bst thead tr.row-subs th.sub-boundary { border-left: 1.5px solid #2563eb; }
table.bst thead tr.row-subs th.th-pos-class { background: #1a2f1a; color: #fef9c3; font-size: 6px; }
table.bst thead tr.row-subs th.th-pos-arm { background: #0a1e38; color: #bfdbfe; font-size: 6px; }

table.bst tbody tr:nth-child(odd)  { background: #ffffff; }
table.bst tbody tr:nth-child(even) { background: #f0f4fa; }
table.bst tbody td {
    padding: 3px 2px; border: 0.5px solid #c5d3e8;
    text-align: center; vertical-align: middle;
    white-space: nowrap; font-size: 7px;
}
table.bst tbody td.td-student {
    text-align: left; padding-left: 5px; font-weight: 700;
    font-size: 7px; white-space: nowrap; min-width: 120px; background: inherit;
}
table.bst tbody td.td-sn { width: 20px; font-size: 7px; color: #64748b; }
table.bst tbody td.td-adm { width: 60px; font-size: 6.5px; color: #374151; }
table.bst tbody td.td-pos { width: 46px; padding: 2px; text-align: center; }

.pos-pair { display: inline-block; text-align: center; }
.pos-t {
    display: block; font-size: 6.5px; font-weight: 700;
    background: #fef3c7; color: #92400e; border-radius: 2px;
    padding: 1px 3px; margin-bottom: 1px; white-space: nowrap;
}
.pos-c {
    display: block; font-size: 6.5px; font-weight: 700;
    background: #dbeafe; color: #1e40af; border-radius: 2px;
...
table.bst tbody tr.stats-lo  td.stats-lbl {
    text-align: left; padding-left: 5px; font-size: 6.5px;
}

table.bst thead tr.row-subjects th.th-promo {
    background: #3b0764; border-left: 2px solid #7c3aed; font-size: 7px;
}
table.bst thead tr.row-subs th.promo-sub {
    background: #3b0764; color: #d8b4fe; border-left: 2px solid #7c3aed; font-size: 6px;
}
table.bst tbody td.td-promo {
    border-left: 2px solid #7c3aed; font-size: 6.5px; text-align: center;
}
.promo-pill {
    display: inline-block; padding: 1px 6px; border-radius: 8px;
    font-size: 6px; font-weight: 700; white-space: nowrap;
}
...
.subj-summary { width: 100%; margin-top: 8px; page-break-inside: avoid; }
.subj-summary h3 {
    background: #0f2342; color: #fff; padding: 5px 10px;
    font-size: 8.5px; font-weight: 700; border-radius: 3px 3px 0 0;
}
table.subj-tbl {
    width: 100%; border-collapse: collapse; border: 1px solid #cbd5e1; font-size: 7.5px;
}
table.subj-tbl thead th {
    background: #1e3a5f; color: #fff; padding: 4px 8px; text-align: center;
    border: 0.5px solid rgba(255,255,255,.15); font-weight: 600; font-size: 7px;
}
...
table.subj-tbl tbody td {
    padding: 3px 8px; border: 0.5px solid #e2e8f0; text-align: center; font-size: 7px;
}
...
.sig-block {
    margin-top: 14px; width: 100%; border: 1px solid #e2e8f0;
    border-radius: 3px; padding: 10px 16px; page-break-inside: avoid;
}
.sig-block table { width: 100%; border-collapse: collapse; }
.sig-block td { width: 25%; text-align: center; padding: 0 10px; vertical-align: bottom; }
.sig-line {
    border-top: 1.5px solid #64748b; padding-top: 4px;
    font-size: 7px; color: #374151; font-weight: 600; margin-top: 30px;
}
</style>
</head>
<body>
...
@php
/**
 * Ordinal helper — handles int, null, 0, and report-card strings like "1st".
 */
...
$isSeniorClass = $schoolclass && ($schoolclass->classcategory->is_senior ?? false);
$gradeBasisLabel = (($grade_basis ?? 'cum') === 'total') ? 'Term Total' : 'Cumulative';
@endphp
...
<table class="meta-strip">
    <tr>
        ...
        <td class="meta-cell" style="width:18%;">
            <span class="m-lbl">Session</span>
            <span class="m-val">{{ $schoolsession->session ?? '-' }}</span>
        </td>
        <td class="meta-cell" style="width:16%;">
            <span class="m-lbl">Term</span>
            <span class="m-val">{{ $schoolterm->term ?? '-' }}</span>
        </td>
        <td class="meta-cell" style="width:14%;">
            <span class="m-lbl">Grade Basis</span>
            <span class="m-val">{{ $gradeBasisLabel }}</span>
        </td>
        <td class="meta-cell" style="width:12%;">
...
<div class="grade-key">
    <div class="grade-key-inner">
        ...
        <span class="gk-legend" style="background:#f0fdf4;color:#166534;">CC</span>=Class Pos (by total) &nbsp;
        ...
        &nbsp;· Positions match student report ranking (total among scored subjects).
    </div>
</div>
    ...
    <thead>
        ...
        <tr class="row-subs">
            @foreach($subjects as $subId => $subInfo)
                ...
                @endif
                @if($showSubPosCC)
                    <th class="th-pos-class" style="min-width:24px;" title="Class-wide by total">CC</th>
                @endif
                @if($showSubPosCT)
                    <th class="th-pos-class" style="min-width:24px;" title="Class-wide by total">CT</th>
                @endif
                @if($showSubPosAT)
                    <th class="th-pos-arm" style="min-width:24px;" title="Arm by total">AC</th>
                @endif
                @if($showSubPosAK)
                    <th class="th-pos-arm" style="min-width:24px;" title="Arm by cum">AK</th>
                @endif
                @if($showAvg)
        ...
        @foreach($studentRows as $idx => $stu)
            ...
            <tr>
                ...
                @foreach($subjects as $subId => $subInfo)
                    ...
                    @if($showSubPosCC)
                        <td class="sp-cc">{{ bsOrdinal($spCC) }}</td>
                    @endif
                    @if($showSubPosCT)
                        <td class="sp-ct">{{ bsOrdinal($spCT) }}</td>
                    @endif
                    @if($showSubPosAT)
                        <td class="sp-at">{{ bsOrdinal($spAT) }}</td>
                    @endif
                    @if($showSubPosAK)
                        <td class="sp-ak">{{ bsOrdinal($spAK) }}</td>
                    @endif
                ...
                @if($showPromoRule)
                    <td class="td-promo" style="color:#64748b;">
                        {{ !empty($stu['promotion_rule_applied']) ? \Illuminate\Support\Str::limit($stu['promotion_rule_applied'], 20) : '—' }}
                    </td>
                @endif
            </tr>
        @endforeach
