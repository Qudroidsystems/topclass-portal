...
return new class extends Migration
{
...
};
    {
        ...
        // ============================================================
        // PART 11: CLUB & SPORT PERMISSIONS
        // ============================================================
        ...
        // ============================================================
        // PART 12: FINANCE LOOKUP & REFERENCE DATA
        // ============================================================
        ...
        // ============================================================
        // PART 14: DEMO / TEST DATA
        // ============================================================

        if (app()->environment('local', 'development')) {

            $this->printSection(
                '🧪 PART 14: DEMO & TEST DATA (Development Environment)'
            );
            ...
            $this->printSection(
                '🚀 PART 14: PRODUCTION ENVIRONMENT'
            );
