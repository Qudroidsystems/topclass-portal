...
class PromotionRuleTemplateController extends Controller
{
    public function index()
    {
        ...
        return view('promotions.templates', compact(
            'templates', 'settings', 'schoolclasses', 'sessions', 'terms', 'pagetitle'
        ));
    }
    ...
    public function create()
    {
        ...
        return view('promotions.templates-create', compact(
            'schoolclasses', 'sessions', 'terms', 'pagetitle'
        ));
    }
    ...
    public function edit($id)
    {
        ...
        return view('promotions.templates-edit', compact(
            'template', 'schoolclasses', 'sessions', 'terms', 'pagetitle'
        ));
    }
    ...
    public function loadForClass(Request $request, $id)
    {
        try {
            ...
            if ($classIsSenior !== $templateIsSenior) {
                return response()->json([
                    'success' => false,
                    'message' => 'Grade scale mismatch. Template uses '
                        . $template->grade_scale
                        . ' but class is '
                        . ($classIsSenior ? 'senior' : 'junior'),
                ], 422);
            }
